...
// ============================================
// WASP locations that can emit F5-managed echoes.
// These locations are not blanket-skipped anymore.
// F2 only suppresses callouts here when they clearly came from F5/our own sync
// (for example ShipStation notes or a recent sync pre-mark).
